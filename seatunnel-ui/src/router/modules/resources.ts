...
export default {
  path: '/resource',
  name: 'resource',
  meta: { title: '资源中心', auth: 'resources:view', activeMenu: 'resource' },
  ...
  children: [
    ...
    },
    {
      ...
      meta: {
        ...
        showSide: true,
        auth: 'resources:file:online-create'
      }
    },
    {
    ...
    {
      path: '/resource/git-manage',
      name: 'git-manage',
      component: components['resource-git'],
      meta: {
        title: 'Git文件',
        activeMenu: 'resource',
        showSide: true,
    ...
    {
      path: '/resource/git-manage/:id',
      name: 'git-manage-sub',
      component: components['resource-git'],
      meta: {
        title: 'Git文件',
        activeMenu: 'resource',
        activeSide: '/resource/git-manage',
        showSide: true,
        auth: 'resources:git-file:view'
      }
    },
    {
    ...
    },
    {
      ...
      meta: {
        ...
        activeMenu: 'resource',
        showSide: true,
        auth: 'resources:task-group:view'
      }
    },
    {
      ...
      meta: {
        ...
        activeMenu: 'resource',
        showSide: true,
        auth: 'resources:task-group-queue:view'
      }
    }
  ]
}
