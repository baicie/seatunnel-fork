  ...
  render() {
    ...
    return (
      <NTabs type='line'>
        <NTabPane
          name='seconde'
          tab={t('crontab.second')}
          disabled={this.disabled.includes('s')}
        >
          <CrontabTime
        ...
        <NTabPane
          name='minute'
          tab={t('crontab.minute')}
          disabled={this.disabled.includes('m')}
        >
          <CrontabTime
        ...
        <NTabPane
          name='hour'
          tab={t('crontab.hour')}
          disabled={this.disabled.includes('H')}
        >
          <CrontabTime
        ...
        <NTabPane
          name='day'
          tab={t('crontab.day')}
          disabled={this.disabled.includes('d')}
        >
          <CrontabDay
        ...
        <NTabPane
          name='year'
          tab={t('crontab.year')}
          disabled={this.disabled.includes('y')}
        >
          <CrontabTime
