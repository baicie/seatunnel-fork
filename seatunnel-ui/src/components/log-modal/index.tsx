...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const switchLogComplete = () => {
      logStore.setComplete(!logStore.getComplete)
  ...
  render() {
    ...
    return (
      <Modal
        ...
        headerLinks={ref([
          {
            text: this.logStore.isComplete
              ? t('project.workflow.business_log')
              : t('project.workflow.complete_log'),
            show: true,
            action: switchLogComplete,
